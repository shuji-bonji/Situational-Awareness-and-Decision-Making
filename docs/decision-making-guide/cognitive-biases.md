...
| バイアス | チェック項目 ||
|---|---|---:|
| **確証バイアス** | 自分の考えと異なる意見を聞くと不快になることがある |⬜︎|
|  | 自分の立場を支持する情報を積極的に探すことが多い |⬜︎|
| **過信バイアス** | 自分は平均より優れた判断力を持っていると思う |⬜︎|
|  | 自分の予測が外れたときに驚くことが多い |⬜︎|
| **損失回避** | 小さな損失の可能性があるだけで選択肢を避ける |⬜︎|
|  | 利益より損失の方が心理的影響が大きい |⬜︎|
| **集団思考** | 会議で反対意見を述べるのが難しいと感じる |⬜︎|
|  | チームの和を乱したくないので批判的意見を控える |⬜︎|
...
次のページでは、[不確実性下の意思決定](./uncertainty.md)について詳しく解説します。
