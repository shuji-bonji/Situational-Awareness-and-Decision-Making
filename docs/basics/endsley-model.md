...
このモデルは、航空業界だけでなく、**軍事作戦の指揮**、**自動車の自動運転**、**災害時の指揮管理**、**医療現場のモニタリング**など、幅広い分野で応用されています。

Endsley博士は1995年の論文[^1]で、今日広く受け入れられている状況認識の3レベルモデルを詳細に提示しました。このモデルは、その後、航空分野を超えて、医療、軍事、緊急対応、自動車運転など多くの分野に応用されています。
